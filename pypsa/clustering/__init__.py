...
class TemporalClusteringAccessor:
    ...
    @wraps(temporal.representative_hours)
    def representative_hours(self, *args: Any, **kwargs: Any) -> "Network":
        """Wrap [`pypsa.clustering.temporal.representative_hours`][]."""
        return temporal.representative_hours(self.n, *args, **kwargs).n
